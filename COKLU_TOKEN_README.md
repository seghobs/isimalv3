...
1. **Çoklu Token Desteği**
   ...
   - Her token için kullanıcı adı, token, Android ID ve User Agent bilgisi
...
3. **User Agent**: Instagram user agent string
4. **Şifre** (Opsiyonel): Instagram şifreniz - Tekrar giriş yap özelliği için
...
- **Düzenle**: Token, Android ID veya User Agent'ı manuel olarak değiştir
...
- Android ID ve User Agent'ın doğru olduğundan emin olun
